...
| Name | Type |
|------|------|
| [aws_organizations_account.main](https://registry.terraform.io/providers/hashicorp/aws/4.44.0/docs/resources/organizations_account) | resource |
...
| <a name="input_account-name"></a> [account-name](#input\_account-name) | The name of the account. | `string` | n/a | yes |
| <a name="input_account-owner"></a> [account-owner](#input\_account-owner) | The email address of the account owner. | `string` | n/a | yes |
