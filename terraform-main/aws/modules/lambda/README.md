...
| <a name="input_file-path"></a> [file-path](#input\_file-path) | Path to the lambda function code. | `string` | n/a | yes |
| <a name="input_handler"></a> [handler](#input\_handler) | The name of the handler method. | `string` | n/a | yes |
| <a name="input_layer_arns"></a> [layer\_arns](#input\_layer\_arns) | ARNs of Lambda layers to use | `list(string)` | `[]` | no |
...
| <a name="input_security-group-ids"></a> [security-group-ids](#input\_security-group-ids) | Security groups to run lambda in. | `list(string)` | `[]` | no |
| <a name="input_subnet-ids"></a> [subnet-ids](#input\_subnet-ids) | Subnets to run lambda in. | `list(string)` | `[]` | no |
...
| <a name="input_timeout"></a> [timeout](#input\_timeout) | The timeout in seconds. | `number` | `30` | no |
| <a name="input_vpc-id"></a> [vpc-id](#input\_vpc-id) | VPC ID for Lambda to run in. | `string` | `null` | no |
