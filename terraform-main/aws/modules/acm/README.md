...
| <a name="input_domain-name"></a> [domain-name](#input\_domain-name) | The domain for the certificate | `string` | n/a | yes |
...
| <a name="input_pca-arn"></a> [pca-arn](#input\_pca-arn) | ARN of the AWS PCA for signing | `string` | n/a | yes |
| <a name="input_region"></a> [region](#input\_region) | The region to create resources in. | `string` | n/a | yes |
| <a name="input_subject-alternative-names"></a> [subject-alternative-names](#input\_subject-alternative-names) | The domain for the certificate | `list(string)` | `[]` | no |
