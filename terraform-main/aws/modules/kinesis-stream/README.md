...
| <a name="input_name"></a> [name](#input\_name) | The stream name. | `string` | n/a | yes |
...
| <a name="input_retention-period"></a> [retention-period](#input\_retention-period) | The number of hours to retain data for | `number` | `24` | no |
